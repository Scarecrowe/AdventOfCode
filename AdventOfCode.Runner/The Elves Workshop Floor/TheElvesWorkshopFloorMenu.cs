namespace AdventOfCode.Runner.The_Elves_Workshop_Floor
{
    using System;
    ...
    public class TheElvesWorkshopFloorMenu : Menu, IMenu
    {
        public TheElvesWorkshopFloorMenu()
            : base("The Elves Workshop Floor")
        {
        }
