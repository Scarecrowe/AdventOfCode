# 🎄 Advent of Code 2024 - Puzzle Summary

## 📜 Overview

A complete summary of all 2024 Advent of Code puzzles.
...
Compare two lists of location IDs.
Part 1 sums absolute differences after sorting.
...
Evaluate safety of level reports.
Check increasing/decreasing patterns.
...
### Day 03 - Mull It Over
Parse corrupted instructions from text.
Extract valid multiplication operations.
...
### Day 04 - Ceres Search
Search for "XMAS" patterns in grid.
...
Simulate guard movement on grid.
...
Try combinations to reach target.
...
Identify antenna interference points.
Extend lines between matching symbols.
...
### Day 10 - Hoof It
Follow increasing paths on grid.
Count reachable peaks.
...
Transform stones using rules.
Split or multiply values.
...
Solve button press combinations.
Use linear equations for prizes.
...
Simulate robots moving on grid.
...
Push boxes in grid with rules.
Handle chain pushing.
...
Find optimal path with turning cost.
...
Run custom instruction program.
...
### Day 18 - RAM Run
Navigate grid while bytes fall.
Avoid blocked cells over time.
...
### Day 19 - Linen Layout
Match towel patterns to designs.
...
Navigate nested keypads.
Minimise button presses.
...
Generate secret numbers sequence.
...
### Day 23 - LAN Party
Analyse computer connections graph.
...
Evaluate logic gate system.
Resolve wire dependencies.
...
Match keys to locks.
Compare shapes and compatibility.
